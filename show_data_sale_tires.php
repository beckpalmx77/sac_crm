...
<head>
    ...
    <title>รายการประวัติการสั่งซื้อสินค้า</title>
...
<div class="container-fluid mt-5">
    <h3>รายการประวัติการสั่งซื้อสินค้า เดือน <?php echo $month_name . " ปี " . $year ?></h3>
...
<script>
    ...
    $(document).ready(function () {
        function loadSalesData() {
            ...
            $.ajax({
                url: 'model/fetch_data_history_sale_tires.php',
                type: 'POST',
                data: {
                    year: year,
                    month: month,
